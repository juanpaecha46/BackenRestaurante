...
public class RemoveItemFromOrderUseCase : IRemoveItemFromOrderUseCase
{
    ...
    public async Task<OrderDto> ExecuteAsync(Guid orderId, Guid itemId, CancellationToken cancellationToken = default)
    {
